...
This foundational script creates a code representation of the map by procedurally populating a 2D grid array by converting 3D coordinates to 2D indices.
